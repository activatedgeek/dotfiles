...
linux = (
    ...
    dict(
        ...
        google_search_engine_id=config.INVENTORY_VARS.get("GOOGLE_SEARCH_ENGINE_ID"),
        google_search_api_key=config.INVENTORY_VARS.get("GOOGLE_SEARCH_API_KEY"),
        hf_token=config.INVENTORY_VARS.get("HF_TOKEN"),
        nvidia_api_key=config.INVENTORY_VARS.get("NVIDIA_API_KEY"),
        nvidia_inference_api_key=config.INVENTORY_VARS.get("NVIDIA_INFERENCE_API_KEY"),
        openai_client_id=config.INVENTORY_VARS.get("OPENAI_CLIENT_ID"),
        openai_client_secret=config.INVENTORY_VARS.get("OPENAI_CLIENT_SECRET"),
